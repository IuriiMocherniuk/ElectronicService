...
import com.softserve.academy.electronicservice.service.DeviceServiceImp;
...
public class DeviceServiceImpTest {
    ...
    public void updateTest() {
        ...
        Device device = new Device("Phone", "iPhone", 1111_222_333_444L, 1, "used");
        when(deviceDao.save(device)).thenReturn(expectedId);
        doNothing().when(deviceDao).update(expectedId, device);
        deviceService.update(expectedId, device);
